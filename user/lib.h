...
int read_map(int fd, u_long offset, void **blk);
int dirty(int fd, u_long offset, u_long len);
...
int list(int index, char *path, u_long path_len, struct Stat *stat);
int listdir(const char *dir, int index, char *path, u_long path_len, struct Stat *stat);
